...
//            encoderDrive(-10,1.0,"strafe");
            ...
            semiTurn("clockwise",135);
            semiTurn("counterclockwise",135);
...
//            telemetry.update();
//            Thread.sleep(2000);
            teleUpdate(""+robot.frontLeft.getCurrentPosition() +"   frontLeft:   " + robot.frontLeft.getTargetPosition() +"   frontRight:   " + robot.frontRight.getTargetPosition() +"   backLeft:   " + robot.backLeft.getTargetPosition() +"   backRight:   " + robot.backRight.getTargetPosition(),"");
            Thread.sleep(3000);
