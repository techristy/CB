...
@Autonomous(name="RightRedTileRunner", group="Pushbot")

public class RightRedTileRunner extends LinearOpMode
    {
    ...
    //PPR - Pulses per revolution (from the manufacturer)
    //CCR = 4 * PPR

    //static final double COUNTS_PER_MOTOR_REV = 1120 ;    //ANDYMARK Motor Encoder ticks
    static final double COUNTS_PER_MOTOR_REV = 2150;    //Yellow Jacket
    static final double DRIVE_GEAR_REDUCTION = 1.0;

    //static final double WHEEL_DIAMETER_INCHES = 4.0 ; //Tile runner
    static final double WHEEL_DIAMETER_INCHES = 3.77 ; //GoBuilda
    static final double COUNTS_PER_INCH = (COUNTS_PER_MOTOR_REV * DRIVE_GEAR_REDUCTION) / (WHEEL_DIAMETER_INCHES * 3.1415);

    // common for both Tile runner and GoBuilda
